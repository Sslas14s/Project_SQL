...
Этот проект представляет собой схему базы данных, имитирующую структуру платформы **Stepik**. В рамках работы спроектированы связи между курсами, уроками, студентами.
